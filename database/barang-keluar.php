<?php
include '../php/data/barang_keluar.php';
?>
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid">
                        <h1 class="mt-4 slide-in-left" >Barang Keluar</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Barang Keluar List</li>
                        </ol>

                        <div class="container">
                            <h2 class="mt-4">Daftar Barang Keluar</h2>
...
<div id="tambah" class="form-container" style="display:none;"> 
    <form action="" method="POST" class="mt-3">
        ...
        <div class="form-group">
            <label for="tujuan_keluar">Tujuan Keluar</label>
            <input type="text" name="tujuan_keluar" class="form-control" required>
        </div>
...
<table class="table table-bordered mt-4">
    ...
    <tbody>
        ...
        <tr align='center'>
            ...
            <td><?php echo $result['tujuan_keluar']; ?></td>

            <td>
                <a href="?Page=barang_keluar&go=delete&id_keluar=<?php echo $result['id_keluar']; ?>" class="btn btn-danger btn-sm">Hapus</a>
            </td>
        </tr>
        <?php
        }
