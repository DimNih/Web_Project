$(document).ready(function () {
    ...
    const adminChannel = pusher.subscribe('admin-to-user');
    ...
    function appendMessage(message) {
        ...
        const timestamp = formatTimestamp(message.timestamp || Date.now()); // Use message.timestamp or current time
    ...
    $('#send-message').click(function () {
        ...
        formData.append('channel', 'admin-to-user');
